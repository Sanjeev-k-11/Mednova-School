...
// Check for and validate the Super Admin ID immediately
$created_by_admin_id = null;
if (isset($_SESSION["super_admin_id"]) && is_numeric($_SESSION["super_admin_id"])) {
    $created_by_admin_id = (int)$_SESSION["super_admin_id"];
} else {
    // If the ID is missing or invalid, add a fatal error and stop execution
    $errors[] = "Fatal Error: Super Admin ID not found. Please log out and log back in.";
}
