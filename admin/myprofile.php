...
$stmt_fetch = mysqli_prepare($link, "SELECT full_name, role, admin_id, email, address, image_url, gender, created_at FROM admins WHERE id = ?");
...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $admin_id = trim($_POST['admin_id']); // Changed from super_admin_id
    ...
    if (isset($_FILES['profile_image']) && $_FILES['profile_image']['error'] === UPLOAD_ERR_OK) {
        $upload_result = uploadToCloudinary($_FILES['profile_image'], 'admin_photos'); 
    ...
    if (!$upload_error) {
        $sql_update = "UPDATE admins SET full_name = ?, email = ?, address = ?, gender = ?, admin_id = ?, image_url = ? WHERE id = ?";
        
        if ($stmt_update = mysqli_prepare($link, $sql_update)) {
            mysqli_stmt_bind_param($stmt_update, "ssssssi", $full_name, $email, $address, $gender, $admin_id, $image_url_to_update, $user_id);
            ...
            if (mysqli_stmt_execute($stmt_update)) {
                ...
                $stmt_refetch = mysqli_prepare($link, "SELECT * FROM admins WHERE id = ?");
...
<body>
        ...
        <div class="profile-content">
            ...
            <div class="profile-info">
                <div class="info-row">
                    ...
                    <span class="info-value"><?php echo htmlspecialchars($profile_data['admin_id']); ?></span>
                </div>
                <div class="info-row">
    ...
    <!-- EDIT PROFILE MODAL (with changes) -->
        ...
        <div class="modal-content">
            ...
            <form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="post" enctype="multipart/form-data">
                ...
                <div class="form-group">
                    ...
                    <input type="text" id="admin_id" name="admin_id" value="<?php echo htmlspecialchars($profile_data['admin_id'] ?? ''); ?>" required>
                </div>
                <div class="form-group">
