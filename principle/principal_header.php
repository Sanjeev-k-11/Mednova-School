...
$loggedInTeacherName = $_SESSION['full_name'] ?? 'principal';
$loggedInTeacherRole = $_SESSION['role'] ?? 'principal';
...
$pageTitle = $pageTitle ?? 'principal Portal';
?>
...
<body class="min-h-screen">
    ...
    require_once "./principal_sidebar.php";
    ?>
